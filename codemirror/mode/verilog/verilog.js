...
TaysCodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  */
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize != tokenBase && state.tokenize != null) return TaysCodeMirror.Pass;
      if (hooks.indent) {
  ...
  TaysCodeMirror.defineMIME("text/x-verilog", {
    name: "verilog"
  });

  TaysCodeMirror.defineMIME("text/x-systemverilog", {
    name: "verilog"
  });
  ...
  TaysCodeMirror.defineMIME("text/x-tlv", {
    name: "verilog",
