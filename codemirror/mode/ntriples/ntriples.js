...
TaysCodeMirror.defineMode("ntriples", function() {
...
TaysCodeMirror.defineMIME("application/n-triples", "ntriples");

// N-Quads is based on the N-Triples format (so same highlighting works)
// https://www.w3.org/TR/n-quads/
TaysCodeMirror.defineMIME("application/n-quads", "ntriples");

// previously used, though technically incorrect media type for n-triples
TaysCodeMirror.defineMIME("text/n-triples", "ntriples");
