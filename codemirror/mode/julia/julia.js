...
TaysCodeMirror.defineMode("julia", function(config, parserConf) {
  ...
  TaysCodeMirror.registerHelper("hintWords", "julia", keywordsList.concat(builtinsList));
...
TaysCodeMirror.defineMIME("text/x-julia", "julia");
