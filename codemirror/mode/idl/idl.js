...
(function(mod) {
  ...
  TaysCodeMirror.registerHelper("hintWords", "idl", builtinArray.concat(keywordArray));
  ...
  TaysCodeMirror.defineMode('idl', function() {
    return {
  ...
  TaysCodeMirror.defineMIME('text/x-idl', 'idl');
});
